...
<body>
	<form:form method="POST" commandName="categoryobj" action="manageproduct">
		<center>
			<h2 style="color: gold">MANAGE PRODUCT</h2>
		</center>
		<br>
			...
			<div ng-switch="select">
				...
				<center>
					<table class="unbordered" class="table-responsive">
						...
						<tr>
							<td align='center' style="color: white"><b>Product ID :<b></td>
						...
						<tr>
							<td align='center' style="color: white"><b>Product Name
									:<b></td>
						...
						<tr>
							<td align='center' style="color: white"><b>Product Author :<b></td>
						...
						<tr>
							<td align='center' style="color: white"><b>Product Price :<b></td>
