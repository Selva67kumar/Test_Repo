...
<body>
	<form:form method="POST" commandName="supplierobj" action="managesupplier">
		<center>
			<h2 style="color: gold">MANAGE SUPPLIER</h2>
		</center>
		<br>
			...
			<div ng-switch="select">
				...
				<center>
					<table class="unbordered" class="table-responsive">
						...
						<tr>
							<td align='center' style="color: white"><b>Supplier ID :<b></td>
							<td><input type='text' name='Supp_id'></td>
						</tr>
						<tr>
							<td>&nbsp;</td>
						</tr>
						<tr>
							<td align='center' style="color: white"><b>Supplier Name
									:<b></td>
						...
						<tr>
							<td align='center' style="color: white"><b>Supplier Description :<b></td>
							<td><input type='text' name='supp_address'></td>
						</tr>
						<tr>
							<td>&nbsp;</td>
						</tr>
